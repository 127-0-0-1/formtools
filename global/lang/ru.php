...
$LANG["word_next_rightarrow"] = "Вперед »";
...
$LANG["phrase_10_per_page"] = "10 на странице";
...
$LANG["phrase_auto_disable_account"] = "Автоматическое отключение уч, записи после # неудачных попыток";
...
$LANG["phrase_back_to_search_results"] = "К результатам";
...
$LANG["phrase_clients_may_edit"] = "Клиенты могут изменять";
...
$LANG["phrase_forms_assigned_to_any_account"] = "Формы назначенные на";
$LANG["phrase_forms_page_default_message"] = "Сообщение по умолчанию";
$LANG["phrase_ft_installation"] = "Инструменты скрипта установки";
...
$LANG["phrase_login_panel_leftarrows"] = "«Назад";
...
$LANG["phrase_multi_select_dropdown"] = "Multi-Select выпадающй список";
...
$LANG["phrase_new_view_all_fields"] = "Новый просмотр - все поля";
...
$LANG["phrase_no_clients"] = "Нет клиентов";
$LANG["phrase_no_forms"] = "Нет формы";
$LANG["phrase_no_limit"] = "No Limit";
$LANG["phrase_no_offset"] = "Без смещения (0)";
...
$LANG["phrase_rows_selected"] = "{\$num_rows} строк выбрано";
...
$LANG["phrase_size_large"] = "Большой (ТЕКСТ)";
...
$LANG["phrase_strip_tags_in_submissions"] = "Образать тэги в ответах";
...
$LANG["text_add_form_step_3_text_2"] = ", указав ваше форме Инструменты";
...
$LANG["text_add_form_step_3_text_6"] = "Это гарантирует, что данные на самом деле направлены Инструменты. Когда вы создали через ваши представления теста, нажмите на кнопку ниже.";
...
$LANG["text_default_file_settings_page"] = "Эта страница определяет настройки загрузки файлов для установки Инструменты. Эти правила распространяются на все файлы, загруженные через Инструменты, если явно не переопределяется для отдельных полей формы. Примечание: если вы измените папку после загрузки файлов были загружены, они будут автоматически перенесены в новую папку.";
...
$LANG["text_edit_admin_menu_page"] = "Вы можете редактировать меню ниже. Чтобы всегда иметь доступ ко всей функциональности имеющихся в Инструменты, необходимы следующие страницы: формы, клиенты, ваша учетная запись, модули, Настройки и Выйти.";
...
$LANG["text_form_tools_login_url"] = "Логин URL для Инструменты.";
...
$LANG["text_install_create_config_file"] = "Инструменты магазинах вашего сервера и настройки базы данных в файл <b>config.php,</b> нашел в вашей / Global / папки. Нажмите кнопку &quot;Создать файл&quot; кнопку, чтобы автоматически генерировать файл на вашем сервере.";
...
$LANG["text_install_form_tools_server_not_supported"] = "К сожалению, form tools не будут иметь возможность запускать на вашем сервере. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Пожалуйста, нажмите здесь</a> для минимальных требований.";
$LANG["text_install_intro"] = "Добро пожаловать в установочный скрипт Инструменты! Пожалуйста, выберите язык.";
$LANG["text_install_system_check"] = "Эта страница проходит несколько тестов на вашей системе, чтобы обеспечить это возможность запускать Инструменты.";
...
$LANG["text_js_required"] = "Включите JavaScript в вашем браузере.";
...
$LANG["text_log_in_to_ft"] = "Войти в Инструменты";
$LANG["text_login"] = "Пожалуйста, войдите.";
...
$LANG["text_no_submissions_found"] = "Не найдено ни одного ответа.";
...
$LANG["notify_no_test_submission"] = "Инструменты не получило успешное представление испытанием.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "Инструменты не в состоянии определить, куда перенаправить когда им не удается войти с искаженным образом. Прошу передать в скрытом поле с именем <b>form_tools_form_url</b> содержащие URL формы.";
